...
#define USB_AUDIO_FEATURE_UNIT_DESCRIPTOR(ch, n)		\
	struct usb_audio_feature_unit_descriptor_##ch##_##n {	\
		...
		uint8_t bmaControls[ch + 1][n];			\
		uint8_t iFeature;				\
	} __attribute__ ((packed))

/* bmaControls */
/* First byte */
#define USB_AUDIO_MUTE				(1 << 0)
#define USB_AUDIO_VOLUME			(1 << 1)
#define USB_AUDIO_BASS				(1 << 2)
#define USB_AUDIO_MID				(1 << 3)
#define USB_AUDIO_TREBLE			(1 << 4)
#define USB_AUDIO_GRAPHIC_EQUALIZER		(1 << 5)
#define USB_AUDIO_AUTOMATIC_GAIN		(1 << 6)
#define USB_AUDIO_DELAY				(1 << 7)
/* Second byte */
#define USB_AUDIO_BASS_BOOST			(1 << 0)
#define USB_AUDIO_LOUDNESS			(1 << 1)
...
#define USB_AUDIO_FORMAT_TYPE_UNDEFINED			0
#define USB_AUDIO_FORMAT_TYPE_I				1
#define USB_AUDIO_FORMAT_TYPE_II			2
#define USB_AUDIO_FORMAT_TYPE_III			3

/* A.3 Format-Specific Control Selectors */
/* A.3.1 MPEG Control Selectors */
#define USB_AUDIO_MPEG_CONTROL_UNDEFINED		0
#define USB_AUDIO_MP_DUAL_CHANNEL_CONTROL		1
#define USB_AUDIO_MP_SECOND_STEREO_CONTROL		2
#define USB_AUDIO_MP_MULTILINGUAL_CONTROL		3
#define USB_AUDIO_MP_DYN_RANGE_CONTROL			4
#define USB_AUDIO_MP_SCALING_CONTROL			5
#define USB_AUDIO_MP_HILO_SCALING_CONTROL		6

/* A.3.2 AC-3 Control Selectors */
#define USB_AUDIO_AC_CONTROL_UNDEFINED			0
#define USB_AUDIO_AC_MODE_CONTROL			1
#define USB_AUDIO_AC_DYN_RANGE_CONTROL			2
#define USB_AUDIO_AC_SCALING_CONTROL			3
#define USB_AUDIO_AC_HILO_SCALING_CONTROL		4
...
struct usb_audio_mpeg_format_specific_descriptor {
	...
	uint8_t bDescriptorSubtype;
	uint16_t wFormatTag;
	uint16_t bmMPEGCapabilities;
	uint8_t bmMPEGFeatures;
} __attribute__ ((packed));
