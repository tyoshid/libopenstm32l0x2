...
/* struct usb_string_descriptor_24 */
USB_STRING_DESCRIPTOR(24);
...
alignas(2) static const struct usb_string_descriptor_24 string_desc2 = {
	.bLength = 50,
	.bDescriptorType = USB_DT_STRING,
	.wData = u"STM32L052K8T USB Speaker"
};
